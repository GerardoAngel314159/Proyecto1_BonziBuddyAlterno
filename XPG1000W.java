/**
 * Clase que implementa la interfaz FuenteAlimentacion para el modelo XPG 1000W.
 */
public class XPG1000W implements FuenteAlimentacion {
    ...
    public void ensamblarFuenteAlimentacion(){
        ...
        nombre = "XPG 1000W";
        descripcion = "Cuenta con la certificacion 80 PLUS PLATINUM";
        precio = 161.43;
        potenciaMaxima = 1000;
    }
}